    ...
    <div className="h-full">
        ...
        <div className="mt-24 grid grid-rows-2 place-items-center gap-12">
            ...
            <div className="grid grid-cols-2 gap-12">
                ...
                <textarea onChange={e => email_handler(e.target.value)} className="w-[200px] h-[50px]"></textarea>
            </div>
            <div className="grid grid-cols-2 gap-12">
                <span>
                    Password {Password}
            ...
            <div className="grid grid-cols-2 gap-12">
                ...
                <textarea onChange={e => password_handler2(e.target.value)} className="w-[200px] h-[50px]"></textarea>
            </div>
